...
public class DDDrawable extends LayerDrawable
{
    ...
    public DDDrawable(Drawable[] layers)
    {
        super(layers);
        init();
    }
     ...
     * @return
     */
    public DDDrawable alpha(int alpha)
    {
        setAlpha(alpha);
        return this;
    }
     ...
     * @return
     */
    public DDDrawable color(int color)
    {
     ...
     * @return
     */
    public DDDrawable strokeColor(int color)
    {
     ...
     * @return
     */
    public DDDrawable corner(float topLeft, float topRight, float bottomLeft, float bottomRight)
    {
    ...
    public DDDrawable cornerAll(float radius)
    {
        corner(radius, radius, radius, radius);
        return this;
    }

    public DDDrawable cornerTopLeft(float radius)
    {
        corner(radius, cornerTopRight, cornerBottomLeft, cornerBottomRight);
        return this;
    }

    public DDDrawable cornerTopRight(float radius)
    {
        corner(cornerTopLeft, radius, cornerBottomLeft, cornerBottomRight);
        return this;
    }

    public DDDrawable cornerBottomLeft(float radius)
    {
        corner(cornerTopLeft, cornerTopRight, radius, cornerBottomRight);
        return this;
    }

    public DDDrawable cornerBottomRight(float radius)
    {
     ...
     * @return
     */
    public DDDrawable strokeWidth(int left, int top, int right, int bottom)
    {
